...
def ringtone_maker(start,end):
	sound_file = AudioSegment.from_file(file_destination+"/"+file_name+"."+file_extension,format=file_extension)
	...
	sliced_audio.export(file_destination+"/"+ringtone_name+"."+file_extension,format=file_extension,bitrate="320k")
...
def time_slice():
	...
	result = ringtone_maker(start_time,end_time)
	pass
